...
SUBMISSION_FOLDER = EVALUATION_PATH.parent.parent / "output_data"
ORIGINAL_FOLDER = EVALUATION_PATH.parent.parent / "input_data"
...
def main() -> dict[Any, Any]:
    ...
    parser.add_argument(
        "--submission",
        type=Path,
        default=Path(SUBMISSION_FOLDER, "zh_qwen14b_lora8_16_1e-6_test.tsv"),
